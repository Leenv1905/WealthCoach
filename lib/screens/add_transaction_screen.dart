...
class AddTransactionScreen extends StatefulWidget {
  final Transaction? transactionToEdit; // Truyền dữ liệu khi sửa
...
class _AddTransactionScreenState extends State<AddTransactionScreen> {
  late final _amountController = TextEditingController(
    text: widget.transactionToEdit?.amount.toStringAsFixed(2) ?? "0.00",
  );
  late TransactionType _type = widget.transactionToEdit?.type ?? TransactionType.expense;
  late String? _category = widget.transactionToEdit?.category;
  late DateTime _selectedDate = widget.transactionToEdit?.date ?? DateTime.now();
  late final _noteController = TextEditingController(
    text: widget.transactionToEdit?.note ?? "",
  );

  final List<String> _categories = [
    'Ăn uống', 'Lương', 'Di chuyển', 'Thuê nhà', 'Cafe',
    'Mua sắm', 'Xăng dầu', 'Điện nước', 'Khác'
  ];
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: Text(_isEditing ? "Edit Transaction" : "Add New"),
        backgroundColor: AppTheme.background,
        elevation: 0,
        actions: const [
          Padding(
            ...
            SizedBox(
              ...
              child: ElevatedButton(
                ...
                style: ElevatedButton.styleFrom(
                  ...
                  foregroundColor: Colors.white,  // Chuữ trắng
  ...
  IconData _getIconForCategory(String category) {
    switch (category) {
      ...
      case 'Lương': return Icons.payments;
      case 'Di chuyển': return Icons.directions_car;
      case 'Thuê nhà': return Icons.home;
      case 'Cafe': return Icons.coffee;
      case 'Mua sắm': return Icons.shopping_basket;
      case 'Xăng dầu': return Icons.local_gas_station;
      case 'Điện nước': return Icons.electric_bolt;
